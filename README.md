...
- [​Экзаменационный билет №3](#экзаменационный-билет-3)
  ...
  - [​\[O\] Уровни привилегий в защищенном режиме. Как они используются в ОС Windows?](#o-уровни-привилегий-в-защищенном-режиме-как-они-используются-в-ос-windows)
- [​Экзаменационный билет №4](#экзаменационный-билет-4)
  ...
  - [​\[O\] Исключение #GP в защищенном режиме. Приведите примеры ситуаций, в которых оно возникнет.](#o-исключение-gp-в-защищенном-режиме-приведите-примеры-ситуаций-в-которых-оно-возникнет)
...
- [​Экзаменационный билет №8](#экзаменационный-билет-8)
  ...
  - [​\[O\] Прерывания в реальном и защищённом режимах работы процессора Intel.](#o-прерывания-в-реальном-и-защищённом-режимах-работы-процессора-intel)
- [​Экзаменационный билет №9](#экзаменационный-билет-9)
  - [​Арифметические инструкции в ассемблере.](#арифметические-инструкции-в-ассемблере)
    ...
    - [​**Циклические сдвиги (на всякий)**](#циклические-сдвиги-на-всякий)
...
- [​Экзаменационный билет №10](#экзаменационный-билет-10)
  - [​\[O\] Запись идентификаторов, целых чисел, символьных данных, комментариев, команд в языке ассемблера.](#o-запись-идентификаторов-целых-чисел-символьных-данных-комментариев-команд-в-языке-ассемблера)
  ...
  - [​\[O\] Прерывания: определение, обработка, роль регистра IDTR.](#o-прерывания-определение-обработка-роль-регистра-idtr)
...
- [​Экзаменационный билет №12](#экзаменационный-билет-12)
  ...
  - [​\[O\] Страничная адресация. Отличия от сегментной, основные структуры данных, схема преобразования линейного адреса в физический.](#o-страничная-адресация-отличия-от-сегментной-основные-структуры-данных-схема-преобразования-линейного-адреса-в-физический)
...
- [​Экзаменационный билет №14](#экзаменационный-билет-14)
  ...
  - [​\[O\] Использование встроенного ассемблера (ассемблерных вставок) в языках более высокого уровня.](#o-использование-встроенного-ассемблера-ассемблерных-вставок-в-языках-более-высокого-уровня)
  - [​\[O\] Отличия между синтаксисами ассемблера Intel и AT\&T.](#o-отличия-между-синтаксисами-ассемблера-intel-и-att)
...
Чем меньшее значение содержит это поле, тем описываемый сегмент круче (0 - самый крутой, 3 – наименее привилегированный). В чем именно «крутость»? Сегмент с нулевым уровнем привилегий может исполнять любые инструкции, обращаться к любым данным. По задумке, в сегментах с 0-ым уровнем должно располагаться ядро ОС, другие части ОС - в сегментах с 1-ым уровнем, драйвера - со 2-ым, пользовательские программы - с 3-им.

На деле программисты из Microsoft при проектировании ОС Windows решили "упростить" модель до двухуровневой: все что не пользовательские программы - то в 0-ом уровне, пользовательские - в третьем. 1-й и 2-й уровни не используются.
...
## ​Схема преобразования виртуального адреса в логический в защищенном режиме.
...
CR – Control Register. Регистр, который отвечает за управление процессором и режимами его работы.
В нем много различных полей, и вдаваться в подробности каждого сейчас не будем, но скажу лишь,
что переход в защищенный режим осуществляется установкой бита PE (Protected Enabled, самый
младший бит регистра) в значение 1.
Доступ регистру возможен через инструкции
