...
- [​Экзаменационный билет №1](#экзаменационный-билет-1)
  ...
  - [​\[O\] Дайте определение дескриптора, опишите, из каких основных полей он состоит. Для чего используются дескрипторы?](#o-дайте-определение-дескриптора-опишите-из-каких-основных-полей-он-состоит-для-чего-используются-дескрипторы)
...
- [​Экзаменационный билет №9](#экзаменационный-билет-9)
  ...
  - [​\[O\] Регистры GDTR/LDTR. Чем селектор защищенного режима отличается от адреса сегмента реального?](#o-регистры-gdtrldtr-чем-селектор-защищенного-режима-отличается-от-адреса-сегмента-реального)
...
- [​Экзаменационный билет №11](#экзаменационный-билет-11)
  ...
  - [​\[O\] Схема преобразования виртуального адреса в логический в защищенном режиме.](#o-схема-преобразования-виртуального-адреса-в-логический-в-защищенном-режиме)
...
- [​Экзаменационный билет №13](#экзаменационный-билет-13)
  ...
  - [​\[O\] Опишите процедуру переключения процессора из реального режима в защищенный.](#o-опишите-процедуру-переключения-процессора-из-реального-режима-в-защищенный)
...
## ​[O] Дайте определение дескриптора, опишите, из каких основных полей он состоит. Для чего используются дескрипторы?
